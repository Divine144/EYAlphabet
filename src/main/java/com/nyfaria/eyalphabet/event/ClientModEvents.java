...
import com.nyfaria.eyalphabet.entity.renderer.JumpscareFEntityRenderer;
...
public class ClientModEvents {
    ...
    public static void onRegisterRenderers(final EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(EntityInit.JUMPSCARE_F.get(), JumpscareFEntityRenderer::new);
