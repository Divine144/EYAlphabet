...
public class FirelightTargetGoal extends NearestAttackableTargetGoal<Player> {
    private UUID firelightId;

    public FirelightTargetGoal(Mob mob) {
        super(mob, Player.class, false);
        this.targetConditions = TargetingConditions.forCombat().range(this.getFollowDistance()).selector(this::checkTarget);
    }
